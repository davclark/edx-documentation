...
``edx.googlecomponent.calendar.displayed`` and
``edx.googlecomponent.document.displayed``
******************************************************************************************

The server emits ``edx.googlecomponent.calendar.displayed`` events when a
Google Calendar component is shown in the LMS. The server emits
``edx.googlecomponent.document.displayed`` events when a Google Drive file,
